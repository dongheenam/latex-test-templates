...
\includecenteredgraphics[width=0.4\textwidth]{_fig/example-pic-quiz-1}
\vspace{1cm}
...
\question* For the diagram on the right, \includegraphicsonright[width=4cm]{_fig/example-pic-quiz-1}
\begin{parts}
