...
% insert an image
% usage: \includecenteredgraphics[width=...]{address-to-file}
...
\includecenteredgraphics[width=0.4\textwidth]{fig/example-pic-quiz-1}
\vspace{1cm}

% insert an image on the right side
% usage: \includegraphicsonright[width=...]{address-to-file}
% note: the text will not wrap around the image, so be careful about it.
\question* For the diagram on the right, \includegraphicsonright[width=4cm]{fig/example-pic-quiz-1}
\begin{parts}
